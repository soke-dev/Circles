  ...
  return [
    {
      ...
      url: '/events/1000',
      location: 'Join hundreds of nigerians to save, you can deposit as you wish, Withdrawals are opened every saturday 10AM UTC to sunday 4PM UTC',
      totalRevenue: '$5900',
    ...
    },
    {
      ...
      name: 'Based Savers',
      url: '/events/1001',
      location: 'Making money on the Base blockchain is great, but saving it is even better. Join fellow enthusiasts to secure some of those returns!',
      totalRevenue: '$1700',
      totalRevenueChange: '+3.2%',
      ticketsSoldChange: '+8.1%',
      pageViews: '1',
    ...
    {
      id: 1002,
      name: 'Business owners onchain savers',
      url: '/events/1002',
      location: 'Business Owners: Start Saving Your Earnings on the Blockchain Today',
      totalRevenue: '$13,400',
      totalRevenueChange: '+3.2%',
      ticketsSoldChange: '+8.1%',
      pageViews: '',
    ...
    {
      id: 1003,
      name: 'Freelancers can save',
      url: '/events/1003',
      location: 'Freelancers: Unlock the Benefits of Saving Your Earnings Onchain',
      totalRevenue: '$3,552',
      totalRevenueChange: '+3.2%',
      ticketsSoldChange: '+8.1%',
      pageViews: '',
